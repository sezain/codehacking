                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                {{--<a href="http://localhost/codehacking/public/admin/users">All Users</a>--}}
                                <a href="{{route('admin.users.index')}}">All Users</a>
                            </li>

                            <li>
                                {{--<a href="http://localhost/codehacking/public/admin/users/create">Create User</a>--}}
